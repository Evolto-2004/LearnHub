...
export function getToken(): string {
  return window.localStorage.getItem("learnhub-frontend-token") || "";
}

export function setToken(token: string) {
  window.localStorage.setItem("learnhub-frontend-token", token);
}

export function clearToken() {
  window.localStorage.removeItem("learnhub-frontend-token");
}
...
export function getDepKey(): string {
  return window.localStorage.getItem("learnhub-frontend-depatmentKey") || "";
}

export function setDepKey(token: string) {
  window.localStorage.setItem("learnhub-frontend-depatmentKey", token);
}

export function clearDepKey() {
  window.localStorage.removeItem("learnhub-frontend-depatmentKey");
}
export function getDepName(): string {
  return window.localStorage.getItem("learnhub-frontend-depatmentName") || "";
}

export function setDepName(token: string) {
  window.localStorage.setItem("learnhub-frontend-depatmentName", token);
}

export function clearDepName() {
  window.localStorage.removeItem("learnhub-frontend-depatmentName");
}
...
export function getPlayId(): string {
  return window.localStorage.getItem("learnhub-play-id") || "";
}

export function savePlayId(id: string) {
  window.localStorage.setItem("learnhub-play-id", id);
}

export function clearPlayId() {
  window.localStorage.removeItem("learnhub-play-id");
}
