...
const DepartmentPage = () => {
          ...
          title: (
            <>
              ...
              <div className="d-flex">
                <Tooltip placement="top" title="Drag to reorder">
                  <i
            ...
            content: (
              <p>
                ...
                <span className="c-red">
                  （{res.data.children.length} child departments）
                </span>
                 Please remove the associations before deleting!
              </p>
            ),
          });
        } else {
            ...
            content: (
              <p>
                ...
                {res.data.courses && res.data.courses.length > 0 && (
                  ...
                  >
                    （{res.data.courses.length} courses)，
                  </Button>
                )}
                {res.data.users && res.data.users.length > 0 && (
                  ...
                  >
                    （{res.data.users.length} learners)，
                  </Button>
                )}
                Please remove the associations before deleting!
              </p>
  ...
  const delUser = (id: any) => {
    confirm({
      ...
      content: "Confirm deletion of this department?",
      centered: true,
      okText: "Confirm",
      cancelText: "Cancel",
      onOk() {
  ...
  const onDrop: TreeProps["onDrop"] = (info) => {
    ...
    if (!info.dropToGap) {
      ...
      loop(data, dropKey, (item) => {
        ...
        // where to insert 示例添加到头部，可以Yes随意位置
  ...
  return (
    <>
      {
        <div className="learnhub-main-top mb-24">
          {contextHolder}
          <div className="d-flex">
            <PerButton
              type="primary"
