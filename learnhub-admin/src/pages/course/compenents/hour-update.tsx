      ...
      {open ? (
        ...
        >
          <div className={styles["top-content"]}>
            <p>1. Lesson changes take effect immediately and cannot be undone. Proceed carefully.</p>
            <p>2. Existing progress will be recalculated when learners continue studying after lesson updates.</p>
          </div>
