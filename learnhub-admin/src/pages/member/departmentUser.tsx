...
const MemberDepartmentProgressPage = () => {
  ...
  const modes = [
    { label: "All", value: "all" },
    { label: "Hide open courses", value: "only_dep" },
  ];
  ...
  const exportExcel = () => {
    ...
    member.departmentProgress(did, page, total, filter).then((res: any) => {
      ...
      let filename = title + "learning-progress.xlsx";
  ...
  return (
    <div className="learnhub-main-body">
      <div className="float-left mb-24">
        <BackBartment title={title + "Progress"} />
      </div>
      <div className="float-left j-b-flex mb-24">
        <div className="d-flex">
          ...
          <div className="helper-text ml-24">
            (Each number below represents “completed lessons / total lessons” for the course column.)
          </div>
        </div>
        <div className="d-flex">
