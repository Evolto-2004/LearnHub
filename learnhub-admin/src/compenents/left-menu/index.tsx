...
const items = [
  ...
  getItem(
    ...
    [
      getItem("Video", "/videos", null, null, null, "resource-menu"),
      getItem("Image", "/images", null, null, null, "resource-menu"),
      getItem("Courseware", "/courseware", null, null, null, "resource-menu"),
    ],
    null,
    null
  ),
  getItem(
    ...
    [getItem("Courses", "/course", null, null, null, "course")],
    null,
    null
  ),
  getItem(
    ...
    [
      getItem("Learner", "/member/index", null, null, null, "user-index"),
      getItem("Department", "/department", null, null, null, "department-cud"),
    ],
    null,
    null
  ),
