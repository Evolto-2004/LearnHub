...
export function getToken(): string {
  return window.localStorage.getItem("learnhub-h5-token") || "";
}

export function setToken(token: string) {
  window.localStorage.setItem("learnhub-h5-token", token);
}

export function clearToken() {
  window.localStorage.removeItem("learnhub-h5-token");
}
...
export function getDepKey(): string {
  return window.localStorage.getItem("learnhub-h5-depatmentKey") || "";
}

export function setDepKey(token: string) {
  window.localStorage.setItem("learnhub-h5-depatmentKey", token);
}

export function clearDepKey() {
  window.localStorage.removeItem("learnhub-h5-depatmentKey");
}
export function getDepName(): string {
  return window.localStorage.getItem("learnhub-h5-depatmentName") || "";
}

export function setDepName(token: string) {
  window.localStorage.setItem("learnhub-h5-depatmentName", token);
}

export function clearDepName() {
  window.localStorage.removeItem("learnhub-h5-depatmentName");
}
