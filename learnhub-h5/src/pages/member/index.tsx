...
const MemberPage = () => {
  ...
  //     Toast.show("Uploads over 2 MB are not allowed");
  //     return null;
  //   }
  //   return file;
  // };
    ...
    <div className={styles["main-body"]}>
      <div className={styles["content-box"]}>
        ...
        <div className={styles["stats-content"]}>
          <div className={styles["stat-item"]}>
            <span className={styles["time"]}>
              <strong> {learnTodayHour} </strong>h
              <strong> {learnTodayMin} </strong>m
            </span>
            <span className={styles["tit"]}>TodayStudy</span>
          </div>
          <div className={styles["stat-item"]}>
            <span className={styles["time"]}>
              <strong> {learnTotalHour} </strong>h
              <strong> {learnTotalMin} </strong>m
            </span>
            <span className={styles["tit"]}>Total Study</span>
          </div>
        </div>
        <div className={styles["records-content"]}>
          ...
          <div className={styles["record-item"]}>
            <div className={styles["name"]}>Total Lesson Progress</div>
          ...
          <div className={styles["record-item"]}>
            <div className={styles["name"]}>Required</div>
            <div className={styles["value"]}>
              Completed{" "}
          ...
          <div className={styles["record-item"]}>
            <div className={styles["name"]}>Optional</div>
        ...
        <div className={styles["dialog-body"]}>
          <div className={styles["dialog-box"]}>
            <div
              ...
              onClick={() => {
                ...
                if (departments.length === 1) {
                  Toast.show({
                    content: "No departments available",
                  });
                  return;
                }
            ...
            <ImageUploader
              ...
              showFailed={false}
            >
              <div className={styles["button-item"]}>Change Avatar</div>
            </ImageUploader>
            <div
              className={styles["button-item"]}
              onClick={() => {
